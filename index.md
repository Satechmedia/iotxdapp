...
You can use the [editor on GitHub](https://github.com/Satechmedia/iotxdapp/edit/gh-pages/index.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/Satechmedia/iotxdapp/settings/pages). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
...
<head>
    ...
    <script>
        ...
        var contractAddressSale = '0xE98e25F4861Da26EB520CC39E60fe1B518522dcd';
        var contractAddressToken = '0xd0E4BD040Fba70704269fdD6894d11E12aba4e3C';
...
<body>
    ...
    <div style="text-align: center">
        <h1>Token info</h1>
        <h2><span id="tokenName">1000PDF Token</span> (<span class="tokenSymbol">1000PDF</span>)</h2>
        <p><a target="_blank" href="https://bscscan.com/token/0xd0E4BD040Fba70704269fdD6894d11E12aba4e3C" id="tokenAddress">0xd0E4BD040Fba70704269fdD6894d11E12aba4e3C</a></p>
    ...
    <div style="text-align: center">
        ...
        <p>Tokens sold: <span id="sold"></span> of <span class="saleqty"></span> <span class="tokenSymbol">1000PDF</span></p>
        <p>Remaining: <span id="toraise"></span> BNB (~ <span id="unsold"></span> <span class="tokenSymbol">1000PDF</span>)</p>
    </div>
    <hr>
    
    <div style="text-align: center">
        <h1>Buy tokens</h1>
        <p>1 BNB = <span class="rate"></span> <span class="tokenSymbol">1000PDF</span></p>
        <p><input type="number" id="buyAmount" value="0" min="0"> BNB</p>
        <p>You get: <span id="get">0</span> <span class="tokenSymbol">1000PDF</span></p>
        ...
        <p>In my wallet: <span id="myTokens"></span> <span class="tokenSymbol">1000PDF</span></p>
    </div>
    <hr>
    
    <div style="text-align: center">
        <h1>Token sale information</h1>
        <p>Hardcap: <span class="hardcap"></span> BNB (~ <span class="saleqty"></span> <span class="tokenSymbol">1000PDF</span>)</p>
        <p>Rate: 1 BNB = <span class="rate"></span> <span class="tokenSymbol">1000PDF</span> (~ <span class="price"></span> BNB/<span class="tokenSymbol">1000PDF</span>)</p>
    ...
    <div style="text-align: center">
        ...
        <p><a href="https://bscscan.com/address/0xE98e25F4861Da26EB520CC39E60fe1B518522dcd" target="_blank" id="saleAddress">0xE98e25F4861Da26EB520CC39E60fe1B518522dcd</a>  <button id="copySale" style="text-align: center">Copy address</button></p>
